...
const AllFoodCard = ({items}) => {
    const {_id, name, image,category,price,quantity} = items || {};
    return (
        <div>
...
<h1 className="text-xl text-center font-bold mb-4"> <span className="text-red-500">{quantity}</span> Available</h1>
